...
| [matrix](connectors/matrix/README.md) | whoami / list-rooms / get-room / send-message / get-messages | — | Matrix C-S API. Bearer auth, login fallback that exchanges password→token at Validate and discards password. |
